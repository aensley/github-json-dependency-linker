// ==UserScript==
// @id          Github_JSON_Dependency_Linker@https://github.com/aensley/github-json-dependency-linker/
// @name        GitHub JSON Dependency Linker
// @namespace   https://github.com/aensley/github-json-dependency-linker/
// @description Add links to dependencies listed in JSON files. Based on "Github JSON Dependencies Linker" by @jerone
// @author      aensley
// @license     GNU GPLv3
// @homepage    https://github.com/aensley/github-json-dependency-linker/
// @homepageURL https://github.com/aensley/github-json-dependency-linker/
// @downloadURL https://github.com/aensley/github-json-dependency-linker/raw/master/GitHub_JSON_Dependency_Linker.user.js
// @updateURL   https://github.com/aensley/github-json-dependency-linker/raw/master/GitHub_JSON_Dependency_Linker.user.js
// @supportURL  https://github.com/aensley/github-json-dependency-linker/issues
// @version     1.0.0
...
(function() {
	var blobElm = document.querySelector('.highlight'),
		...
		isComposer = location.pathname.endsWith('/composer.json'),
